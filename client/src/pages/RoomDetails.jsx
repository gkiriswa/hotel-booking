...
const RoomDetails = () => {
    ...
    const checkAvailability = async ()=>{
      ...
      //onSubmit handler to check the availability and book the room
       ...
       <div className='flex flex-col lg:flex-row mt-6 gap-6'>
        ...
        <div className='flex flex-col md:flex-row md:justify-between mt-10'> 
         ...
         p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
          <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10
           text-gray-500'>
              ...
              <div className='flex flex-col'>
                ...
                min={checkInDate} disabled={!checkInDate} type="date" 
          ...
          <button type='submit' className='bg-blue-400 hover:bg-primary-dull 
          active:scale-95 transition-all
           text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3 
...
<div className='flex flex-col items-start gap-6'>
  ...
  <button 
  className='px-6 py-2.5 mt-4 rounded text-white bg-blue-500 hover:bg-primary-dull 
  focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-all cursor-pointer'
>
  Contact Now
</button>
</div>
