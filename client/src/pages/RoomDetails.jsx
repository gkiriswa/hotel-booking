...
<div className='flex flex-col items-start gap-6'>
  ...
  <button 
  className='px-6 py-2.5 mt-4 rounded text-white bg-blue-500 hover:bg-primary-dull focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-all cursor-pointer'
>
  Contact Now
</button>
</div>
